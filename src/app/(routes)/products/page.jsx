...
export default function Home() {
	return (
		<div className="min-h-screen bg-black text-white">
			...
			>
				<VideoBackground videoSrc="/videos/solar-background.mp4">
					...
					<div className="relative h-80 rounded-lg overflow-hidden">
						...
						<div className="absolute inset-0 bg-gradient-to-r from-black/70 to-transparent flex items-center">
							<div className="p-8 max-w-lg">
								...
								<p className="text-gray-300">
									By combining quantum computing with
									artificial intelligence, we address both
									material science limitations and systemic
									inefficiencies in solar energy deployment.
								</p>
							</div>
						</div>
					</div>
			...
			<section id="technical" className="py-20 bg-black">
				<div className="container mx-auto px-4">
					<h2 className="text-3xl md:text-5xl font-bold mb-6 text-center">
						Technical Approach
					</h2>
					...
					<div className="flex flex-col md:flex-row gap-12">
						<div className="md:w-1/2">
							<h3 className="text-2xl font-bold mb-6 flex items-center">
								<Cpu className="h-6 w-6 text-orange-500 mr-3" />
								Quantum Computing
							</h3>
							<div className="bg-gray-900/70 p-6 rounded-lg mb-8">
								<p className="text-gray-300 mb-4">
									We model complex material properties at the
									atomic level to discover high-efficiency,
								...
								<ul className="space-y-3 text-gray-300">
									...
									<li className="flex items-start">
										...
										<span>
											Energy density and charge cycle
											enhancement
										</span>
									</li>
									<li className="flex items-start">
							...
							<div className="relative h-60 rounded-lg overflow-hidden">
								<Image
									...
									alt="Quantum Computing for Materials"
									fill
									className="object-cover"
								/>
							</div>
						...
						<div className="md:w-1/2">
							<h3 className="text-2xl font-bold mb-6 flex items-center">
								<BrainCircuit className="h-6 w-6 text-orange-500 mr-3" />
								Artificial Intelligence & Machine Learning
							</h3>
							<div className="bg-gray-900/70 p-6 rounded-lg mb-8">
								<p className="text-gray-300 mb-4">
									We train predictive models using
									environmental data (sunlight, weather) to
									optimize panel placement, automate
									maintenance, and balance grid load.
								</p>
								<ul className="space-y-3 text-gray-300">
									<li className="flex items-start">
										<span className="text-orange-500 mr-2">
										...
										<span>
											Deep learning for solar irradiance
											prediction
										</span>
									</li>
									<li className="flex items-start">
										...
										<span>
											Computer vision for panel placement
											optimization
										</span>
									</li>
									<li className="flex items-start">
									...
									<li className="flex items-start">
										...
										<span>
											Reinforcement learning for grid load
											balancing
										</span>
									</li>
								</ul>
					...
					<div className="flex flex-col md:flex-row items-center gap-12">
						...
						<div className="md:w-1/2">
							...
							<ul className="space-y-6">
								<li className="flex items-start">
									<div className="mt-1 mr-4 p-2 bg-orange-500/20 rounded-full">
									...
									<div>
										...
										<p className="text-gray-300">
											...
											efficiency and reduce costs in solar
											deployment
										</p>
									</div>
								</li>
								<li className="flex items-start">
									...
									<div>
										...
										<p className="text-gray-300">
											Public sector entities aiming to
											meet renewable energy targets and
								...
								<li className="flex items-start">
									...
									<div>
										...
										<p className="text-gray-300">
											Regions transitioning to clean
											energy with limited infrastructure
											and resources
										</p>
									</div>
								</li>
				...
				<div className="container mx-auto px-4">
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
						<div className="bg-gray-900/50 p-6 rounded-lg text-center">
							...
							<p className="text-gray-300 text-sm">
								PhD in Quantum Physics with 10+ years experience
								in material simulation and quantum algorithms.
							</p>
						</div>
						...
						<div className="bg-gray-900/50 p-6 rounded-lg text-center">
							...
							<p className="text-gray-300 text-sm">
								Former Google AI researcher specializing in
								predictive modeling and computer vision for
								renewable energy.
							</p>
						</div>
						...
						<div className="bg-gray-900/50 p-6 rounded-lg text-center">
							...
							<p className="text-gray-300 text-sm">
								20+ years in solar deployment across 4
								continents, specializing in off-grid solutions
